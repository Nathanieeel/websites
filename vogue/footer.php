                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <div class="footer-items">
                                <!-- Footer Title -->
                                <h3 class="footer-title text-uppercase mb-2">Partnership</h3>
                                <ul>
...
?>
        ...
        <div class='col-12 col-md-6 col-lg-3 '>
            <div class='single-service p-2 '  >
                <h4><a class='service-btn mt-3 ' href="contact.php">Data Privacy</a></h4>
            </div>
        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                ...
                                <!-- Copyright Right -->
                                <div class="copyright-right">Made with <i class="fas fa-heart"></i> By <a href="https://facebook.com/hillsoftsnetwork">Nathaniel Ibarbia</a></div>
                            </div>
                        </div>
                    </div>
                </div>
