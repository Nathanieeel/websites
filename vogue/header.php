...
?>
    <!-- Title  -->
    <title>NEU CCEL - <?php print $site_title ?></title>
...
?>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="services" class="nav-link">Partnership</a>
                        </li>
                        <li class="nav-item">
                            <a href="portfolio" class="nav-link">Outreach Program</a>
                        </li>
...
";
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a href="contact" class="btn ml-lg-auto btn-bordered-white"><i class="fa fa-user-secret contact-icon mr-md-2"></i>Data Privacy</a>
                        </li>
                    </ul>
                </div>
            </nav>
